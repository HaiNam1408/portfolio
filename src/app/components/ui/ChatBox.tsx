  ...
  const [messages, setMessages] = useState<Message[]>([
    {
        ...
        type: "bot",
        text: "Hi! I'm Nam's personal assistant. Ask me anything about his work, experience, skills, or projects, or choose from the suggested questions!",
    },
    {
        id: crypto.randomUUID(),
        type: "user",
  ...
  return (
    <div className="z-10 flex flex-col fixed bottom-24 right-8 h-[70%] w-[500px] bg-black rounded-xl border border-[#27272a]">
      ...
      {messages.length === 0 ? (
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3 text-sm font-light">
      ...
      <form onSubmit={(e) => handleSend(e)} className="p-3">
        ...
        >
          <SendIcon size={20} onClick={(e) => handleSend(e)} className="text-white dark:text-black" />
        </button>
      </form>
    </div>
  );
